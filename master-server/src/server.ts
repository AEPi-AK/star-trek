...
var task_templates: TaskTemplate[] = [
  {
    description: 'Press the flashing white button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressWhiteButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationB-white-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationB-white-button');
    },
    enabled: s => s.enabled.stationB.whiteButton,
    completed: s => s.stationB.whiteButton.pressed,
  },
  {
    description: 'Press the flashing white button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressWhiteButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationC-white-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationC-white-button');
    },
    enabled: s => s.enabled.stationC.whiteButton,
    completed: s => s.stationC.whiteButton.pressed,
  },
  {
    description: 'Press the flashing white button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressWhiteButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationD-white-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationD-white-button');
    },
    enabled: s => s.enabled.stationD.whiteButton,
    completed: s => s.stationD.whiteButton.pressed,
  },
  {
    description: 'Press the flashing green button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressGreenButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationA-green-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationA-green-button');
    },
    enabled: s => s.enabled.stationA.greenButton,
    completed: s => s.stationA.greenButton.pressed,
  },
  {
    description: 'Press the flashing green button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressGreenButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationC-green-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationC-green-button');
    },
    enabled: s => s.enabled.stationC.greenButton,
    completed: s => s.stationC.greenButton.pressed,
  },
  {
    description: 'Press the flashing green button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressGreenButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationD-green-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationD-green-button');
    },
    enabled: s => s.enabled.stationD.greenButton,
    completed: s => s.stationD.greenButton.pressed,
  },
  {
    description: 'Press the flashing yellow button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressYellowButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationA-yellow-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationA-yellow-button');
    },
    enabled: s => s.enabled.stationA.yellowButton,
    completed: s => s.stationA.yellowButton.pressed,
  },
  {
    description: 'Press the flashing yellow button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressYellowButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationB-yellow-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationB-yellow-button');
    },
    enabled: s => s.enabled.stationB.yellowButton,
    completed: s => s.stationB.yellowButton.pressed,
  },
  {
    description: 'Press the flashing yellow button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressYellowButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationC-yellow-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationBCyellow-button');
    },
    enabled: s => s.enabled.stationC.yellowButton,
    completed: s => s.stationC.yellowButton.pressed,
  },
  {
    description: 'Press the flashing blue button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressBlueButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationA-blue-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationA-blue-button');
    },
    enabled: s => s.enabled.stationA.blueButton,
    completed: s => s.stationA.blueButton.pressed,
  },
  {
    description: 'Press the flashing blue button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressBlueButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationB-blue-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationB-blue-button');
    },
    enabled: s => s.enabled.stationB.blueButton,
    completed: s => s.stationB.blueButton.pressed,
  },
  {
    description: 'Press the flashing blue button',
    frequencyType: FrequencyTaskType.PressButton,
    exclusionType: ExclusionTaskType.PressBlueButton,
    start: () => {
      io.sockets.emit('button-flash', 'stationD-blue-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'stationD-blue-button');
    },
    enabled: s => s.enabled.stationD.blueButton,
    completed: s => s.stationD.blueButton.pressed,
  },

  {
    description: 'Scan hand at Security',
    frequencyType: FrequencyTaskType.ScanHand,
    exclusionType: ExclusionTaskType.ScanHand,
    start: null,
    end: null,
    enabled: s => s.enabled.stationC.touchpad,
    completed: s => s.stationC.touchpad.pressed,
  },

  {
    description:
      'Flip the yellow and green colored switches to the down position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
    enabled: s =>
      s.enabled.stationD.yellowSwitch && s.enabled.stationB.greenSwitch,
    completed: s =>
      s.stationD.yellowSwitch.pressed && s.stationB.greenSwitch.pressed,
  },
  {
    description:
      'Flip the yellow and green colored switches to the up position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
  ...
  {
    description:
      'Flip the yellow and blue colored switches to the down position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
    enabled: s =>
      s.enabled.stationD.yellowSwitch && s.enabled.stationC.blueSwitch,
    completed: s =>
      s.stationD.yellowSwitch.pressed && s.stationC.blueSwitch.pressed,
  },
  {
    description: 'Flip the yellow and blue colored switches to the up position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
  ...
  {
    description:
      'Flip the yellow and red colored switches to the down position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
    enabled: s =>
      s.enabled.stationD.yellowSwitch && s.enabled.stationA.redSwitch,
    completed: s =>
      s.stationD.yellowSwitch.pressed && s.stationA.redSwitch.pressed,
  },
  {
    description: 'Flip the yellow and red colored switches to the up position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
  ...
  {
    description:
      'Flip the green and blue colored switches to the down position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
    enabled: s =>
      s.enabled.stationB.greenSwitch && s.enabled.stationC.blueSwitch,
    completed: s =>
      s.stationB.greenSwitch.pressed && s.stationC.blueSwitch.pressed,
  },
  {
    description: 'Flip the green and blue colored switches to the up position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
  ...
  {
    description: 'Flip the green and red colored switches to the down position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
    enabled: s =>
      s.enabled.stationB.greenSwitch && s.enabled.stationA.redSwitch,
    completed: s =>
      s.stationB.greenSwitch.pressed && s.stationA.redSwitch.pressed,
  },
  {
    description: 'Flip the green and red colored switches to the up position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
  ...
  {
    description: 'Flip the blue and red colored switches to the down position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
    enabled: s => s.enabled.stationA.redSwitch && s.enabled.stationC.blueSwitch,
    completed: s =>
      s.stationA.redSwitch.pressed && s.stationC.blueSwitch.pressed,
  },
  {
    description: 'Flip the blue and red colored switches to the up position',
    frequencyType: FrequencyTaskType.FlipSwitches,
    exclusionType: ExclusionTaskType.FlipSwitches,
    start: null,
    end: null,
  ...
  {
    description: 'Plug the Red wire into the port labelled To at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotTo == Color.Red,
  },
  {
    description: 'Plug the Blue wire into the port labelled To at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotTo == Color.Blue,
  },
  {
    description: 'Plug the Yellow wire into the port labelled To at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotTo == Color.Yellow,
  },
  {
    description: 'Plug the Red wire into the port labelled Too at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotToo == Color.Red,
  },
  {
    description: 'Plug the Blue wire into the port labelled Too at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotToo == Color.Blue,
  },
  {
    description:
      'Plug the Yellow wire into the port labelled Too at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotToo == Color.Yellow,
  },
  {
    description: 'Plug the Red wire into the port labelled Two at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotTwo == Color.Red,
  },
  {
    description: 'Plug the Blue wire into the port labelled Two at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotTwo == Color.Blue,
  },
  {
    description:
      'Plug the Yellow wire into the port labelled Two at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slotTwo == Color.Yellow,
  },
  {
    description: 'Plug the Red wire into the port labelled 10 at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slot10 == Color.Red,
  },
  {
    description: 'Plug the Blue wire into the port labelled 10 at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slot10 == Color.Blue,
  },
  {
    description: 'Plug the Yellow wire into the port labelled 10 at Operations',
    frequencyType: FrequencyTaskType.Plugboard,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationB.plugboard,
    completed: s => s.stationB.plugboard.slot10 == Color.Yellow,
  },

  {
    description: 'Enter 5524 on the keypad',
    frequencyType: FrequencyTaskType.ReadCode,
    exclusionType: ExclusionTaskType.Plugboard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationA.keypad,
    completed: s => s.stationA.keypad.currentString === '5524',
  },

  {
    description: "Scan Montgomery Scott's ID card at Security",
    frequencyType: FrequencyTaskType.ScanCard,
    exclusionType: ExclusionTaskType.ScanCard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationC.touchpad,
    completed: s => s.stationD.rfidScanner.cardID === '1044210282',
  },
  {
    description: "Scan the Engineer's ID card at Security",
    frequencyType: FrequencyTaskType.ScanCard,
    exclusionType: ExclusionTaskType.ScanCard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationC.touchpad,
    completed: s => s.stationD.rfidScanner.cardID === '106942132',
  },
  {
    description: 'Scan an ID card with access level IV at Security',
    frequencyType: FrequencyTaskType.ScanCard,
    exclusionType: ExclusionTaskType.ScanCard,
    start: null,
    end: null,
    enabled: s => s.enabled.stationC.touchpad,
    completed: s => s.stationD.rfidScanner.cardID === '12341684',
  },
  {
    description: 'Press the Big Red Button',
    frequencyType: FrequencyTaskType.PressBigButton,
    exclusionType: ExclusionTaskType.PressBigButton,
    start: () => {
      io.sockets.emit('button-flash', 'big-red-button');
    },
    end: () => {
      io.sockets.emit('button-stop-flash', 'big-red-button');
    },
    enabled: s => s.enabled.bigRedButton,
    completed: s => s.bigRedButton.pressed,
  },
];
...
function taskTemplateValid(task: TaskTemplate) {
  return (
    task.enabled(hardware_state) &&
    !task.completed(hardware_state) &&
    game_state.tasks.filter(({ exclusionType: t }) => t === task.exclusionType)
      .length === 0
  );
}
...
function pickRandomTaskTemplate(): TaskTemplate {
  ...
  //@ts-ignore
  var type_keys: number[] = Object.keys(FrequencyTaskType)
    .filter(k => typeof FrequencyTaskType[k as any] === 'number')
    .map(k => FrequencyTaskType[k as any]);
  ...
  for (var i = 0; i < valid_tasks.length; i++) {
    accum +=
      ...
      total *
      1 /
      counts[valid_tasks[i].frequencyType] *
      game_state.weights[valid_tasks[i].frequencyType];
    if (accum > rand) {
...
function createTaskFromTemplate(template: TaskTemplate): Task {
  ...
  end_time.setSeconds(
    time.getSeconds() + game_state.durations[template.frequencyType],
  );
  var id = task_id++;
  return {
    description: template.description,
    time_created: time.getTime(),
    time_expires: end_time.getTime(),
    id: id,
    exclusionType: template.exclusionType,
...
function startGame() {
  ...
  game_timer_ids.push(
    setInterval(() => {
      ...
      if (
        time_since_last_made >= game_state.task_frequency ||
        (time_since_last_made >= 1 && game_state.tasks.length === 0)
      ) {
  ...
  game_timer_ids.push(
    setInterval(() => {
      ...
      var ended_tasks = game_state.tasks.filter(
        ({ time_expires: end }) => end < now.getTime(),
      );
      ...
      game_state.tasks = game_state.tasks.filter(
        ({ time_expires: end }) => end >= now.getTime(),
      );
...
io.on('connect', function(socket: SocketIO.Socket) {
  ...
  socket.on('identification', function(data: string) {
    ...
    if (data === 'button-1') {
      ...
      socket.on(
        'button-pressed',
        (obj: { pressed: boolean; label: string; lit: boolean }) => {
          console.log(
            'button %s now %s',
            obj.label,
            obj.pressed ? 'pressed' : 'unpressed',
          );
        },
      );
    }
